...
import livechickens from "@/public/models/frozenChickenBulkPurchases.json";
...
const FrozenChickensBulkPurchases = () => {
  ...
  const frozenChickensPriceRange = [
    [1000, 2000],
    [3000, 5000],
    [6000, 8000],
    [9000, 10000],
  ...
  useEffect(() => {
    const fetchData = async () => {
      const data = await fetch("/models/frozenChickenBulkPurchases.json").then(
        (res) => res.json()
      );
    ...
    <section className="flex gap-5 tablet:mx-8 tablet:mt-20 mobile:mt-24">
      {!loading && (
        <div className="mobile:hidden tablet:flex">
          <Filter
            priceRange={frozenChickensPriceRange}
      ...
      {loading ? (
        ...
        <div>
          <div className="text-center h-20 mobile:block tablet:hidden text-2xl mt-8 fixed top-16 left-0 z-10 right-0 text-black bg-white">
            <p className="mt-6">Frozen Chickens Bulk Purchases</p>
            ...
            <div className="flex justify-between mx-10 tablet:flex mobile:hidden ">
              <div>
                <h1 className="desktop:text-2xl tablet:text-lg ">
                  Frozen Chickens Bulk Purchases
                </h1>
              </div>
...
export default FrozenChickensBulkPurchases;
