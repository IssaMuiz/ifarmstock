...
const ProductCategory: React.FC<ProductPageProps> = ({category}) => {
  ...
  useEffect(() => {
   const fetchProducts = async (page = 1) => {
    ...
    const res = await fetch(`/app/api/products?${queryParams}`)
    ...
    fetchProducts()
  }, [category, filter, sortOption, currentPage, setCurrentPage, setTotalPages]);
