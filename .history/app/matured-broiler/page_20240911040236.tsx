            ...
            <div className="flex justify-center text-black mt-2 bg-white text-lg p-2 border-b-4 border-t-4">
              ...
              >
                <div className="relative w-full h-full">
                  <div onClick={toggleFilteredPanel} className="flex justify-between items-center bg-gray-200 p-4 sticky top-0 z-20 shadow-md">
                    <button className="text py-2 px-4 rounded font-semibold ">Apply</button>
                    <button
                    onClick={resetFilter}
