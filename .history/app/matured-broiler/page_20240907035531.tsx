...
const MaturedBroiler = () => {
  ...
  return (
    <section className="flex gap-5 mx-20 mt-14 h-auto">
      ...
      <div className="Broiler-cards h-auto bg-white p-3 w-full rounded-md items-center ">
        <div className="flex justify-between mx-5">
          ...
          >
            ...
            {isOpen && (
              <div className="absolute left=5 w-48 mt-48 origin-top-right bg-white border border-gray-200 rounded-md shadow-lg">
                <div
                  className="py-1 "
                  role="menu"
