    ...
    <section className="flex gap-5 mx-10 mt-20 h-auto">
      ...
      <div className="Broiler-cards h-auto bg-white p-3 w-full rounded-md items-center ">
        <div className="flex justify-between mx-10">
          <div>
            <h1 className="text-2xl ">Matured Broiler</h1>
          </div>
          ...
          >
            ...
            {isOpen && (
              <div className="absolute z-10 h-auto w-52 mt-60  origin-top-right bg-white border border-gray-200 rounded-md shadow-lg">
                <div
                  className="py-5 "
                  role="menu"
                ...
                >
                  {sortingOptions.map((option) => (
                    <label
                      ...
                      key={option.value}
                      className="flex items-center px-4 py-2 cursor-pointer text-gray-700 hover:text-gray-900"
                    >
                      <span
                        className={`w-6 h-6 mr-2 relative p-2 rounded-full border-2 ${
                      ...
                      >
                        {sortingSelected && (
                          <div
                            className={`w-3 h-3 absolute rounded-full border left-1 top-1 p-2 mr-1 border-white ${
                              sortingSelected === option.value &&
