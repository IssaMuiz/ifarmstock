...
const MaturedBroiler = () => {
  ...
  return (
    <section className="flex gap-5 mx-14 mt-20 h-auto">
      ...
      <div className="Broiler-cards h-auto bg-white p-3 w-full rounded-md items-center ">
        <div className="flex justify-between mx-10">
          ...
          >
            ...
            {isOpen && (
              <div className="absolute  w-48 mt-48 origin-top-right bg-white border border-gray-200 rounded-md shadow-lg">
                <div
                  className="py-1 "
                  role="menu"
