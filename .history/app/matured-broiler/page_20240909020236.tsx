  ...
  return (
    <section className="flex gap-5 tablet:mx-8 tablet:mt-20 mobile:mt-24 h-auto">
      ...
      {products.length === 0 ? (
        ...
        <div>
          <div className="text-center h-20 mobile:block tablet:hidden text-2xl mt-10 fixed top-16 left-0 z-10 right-0 text-black bg-white pb-2">
            <p className="mt-6">Mature Live Broiler</p>
            <div className="flex gap-2 justify-center text mt-2 bg-gray-300 text-lg">
              <button type="button" className="border-r pr-2 border-r-black ">
                Sort
              </button>
