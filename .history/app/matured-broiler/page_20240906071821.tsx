      ...
      <div className="Broiler-cards h-auto bg-white p-3 w-full rounded-md flex flex-col items-center ">
        ...
        <div className="flex gap-4 mx-auto">
          <button
            ...
            className={`border p-3 hover:border-green-600 text-base ${
              currentPage === 1
                ? "bg-gray-300 text-gray-300 cursor-not-allowed opacity-50"
                : ""
            }`}
          >
            Prev
          ...
          {getPagenumbers().map((pageNumber) => (
            <button
              ...
              className={`${
                pageNumber === currentPage ? "active bg-green-600 text " : ""
