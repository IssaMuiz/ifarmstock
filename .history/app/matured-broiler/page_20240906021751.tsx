...
const maturedBroiler = () => {
  return (
    <section className="flex gap-5 mx-7 mt-20 h-screen">
      ...
      <div className="Broiler-cards bg-white p-3 w-full rounded-md ">
        <div className="bg-white h-auto w-auto tablet:p-4 mobile:p-1">
          <div className="grid grid-cols-3 overflow-y-scroll p-4">
