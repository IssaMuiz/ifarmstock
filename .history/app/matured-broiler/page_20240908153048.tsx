    ...
    <section className="flex gap-5 tablet:mx-8 mt-20 h-auto">
      ...
      {products.length === 0 ? (
        ...
        <div className="Broiler-cards h-auto bg-white p-3 w-full rounded-md items-center ">
          <div className="DESKTOP-SORTING flex justify-between mx-10 tablet:flex mobile:hidden">
            <div>
          ...
          <div className="MOBILE-SORTING flex justify-between mx-10 tablet:hidden mobile:flex">
            <div>
              <h1 className="text-2xl ">Matured Live Broiler</h1>
            </div>
          ...
          <div className="bg-white h-auto flex flex-col items-center w-auto tablet:p-4 mobile:p-0">
