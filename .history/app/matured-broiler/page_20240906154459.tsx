...
const MaturedBroiler = () => {
  ...
  return (
    <section className="flex gap-5 mx-7 mt-20 h-auto">
      <div className="Left-side-sorting mobile:hidden tablet:flex flex-col bg-white p-3 w-[350px] rounded-md h-[440px]">
          ...
          <ul className="grid desktop:grid-cols-3 tablet:grid-cols-2 mobile:grid-cols-1 p-4">
            {currentProducts.map((product, index) => (
              ...
              >
                ...
                <button
                  type="button"
                  className="border w-full bg-green-600 hover:bg-green-500 text-white p-2 font-semibold rounded-md text-base"
                >
                  Add To Cart
                </button>
              </li>
