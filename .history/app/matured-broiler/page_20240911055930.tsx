      ...
      {products.length === 0 ? (
        ...
        <div>
            ...
            <div className="flex justify-center text-black mt-2 bg-white text-lg p-2 border-b-4 border-t-4">
              ...
              >
                <div className="relative w-full h-full ">
                  <div
                    onClick={toggleFilteredPanel}
                    className="flex justify-between items-center bg-white p-4 sticky top-0 z-20 shadow-md"
                  >
                    <button className="text p-1 rounded-md font-semibold bg-green-600">
                      Apply
                    </button>
                    <button
                      onClick={resetFilter}
                      className="bg-red-600 text font-semibold text p-1 rounded-md"
                    >
                      Reset
                    </button>
                  </div>
          ...
          <div className="Broiler-cards h-auto bg-white p-3 w-full rounded-md items-center pb-5">
            ...
            {/* Products Cards */}
            <div className="bg-white h-auto flex flex-col items-center w-auto tablet:p-2 mobile:p-0 tablet:mt-1 mobile:mt-24">
