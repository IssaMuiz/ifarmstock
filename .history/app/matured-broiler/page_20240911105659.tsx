      ...
      {loading ? (
        ...
        <div>
          <div className="text-center h-20 mobile:block tablet:hidden text-2xl mt-8 fixed top-16 left-0 z-10 right-0 text-black bg-white">
            ...
            <div className="flex justify-between text-black mt-2 bg-white text-lg p-2 border-b-4 border-t-4">
              <div
                onClick={toggleSortPanel}
                className="flex gap-1 items-center  w-max border-r border-r-black   cursor-pointer
              "
              >
                <Image
                  className="h-5 w-5"
              ...
              <div className="flex gap-1 items-center w-max cursor-pointer ">
                <Image
                  className="h-5 w-5"
                  ...
                  height={10}
                />
                <button onClick={toggleFilteredPanel} type="button">
                  Filter
                </button>
              </div>
