  ...
  return (
    <section className="flex gap-5 tablet:mx-8 tablet:mt-20 mobile:mt-24 h-auto">
      ...
      {products.length === 0 ? (
        ...
        <div>
          <div className="text-center h-20 mobile:block tablet:hidden text-2xl mt-8 fixed top-16 left-0 z-10 right-0 text-black bg-gray-200">
            <p className="mt-5">Mature Live Broiler</p>
          </div>
          <div className="Broiler-cards h-auto bg-white p-3 w-full rounded-md items-center ">
            ...
            <div className="bg-white h-auto flex flex-col items-center w-auto tablet:p-4 mobile:p-0 mt-18">
