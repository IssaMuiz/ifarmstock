                ...
                >
                  {sortingOptions.map((option) => (
                    <label
                      ...
                      key={option.value}
                      className="flex items-center px-4 py-2 cursor-pointer text-gray-700 hover:bg-gray-100 hover:text-gray-900"
                    >
                      <span
                        className={`w-4 h-4 mr-2 relative p-2 rounded-full border-4 ${
                      ...
                      >
                        {sortingSelected && (
                          <div
                            className={`w-2 h-2 absolute rounded-full border top-1 right-1 ${
                              sortingSelected === option.value &&
