  ...
  return (
    <section className="flex gap-5 tablet:mx-8 tablet:mt-20 mobile:mt-24 h-auto">
      ...
      {products.length === 0 ? (
        ...
        <div>
          <div className="text-center h-20 mobile:block tablet:hidden text-2xl mt-8 fixed top-16 left-0 z-10 right-0 text-black bg-white pb-10">
          ...
          <div className="Broiler-cards h-auto bg-white p-3 w-full rounded-md items-center pb-5">
            <div className="flex justify-between mx-10 tablet:flex ">
              <div>
