        ...
        <div>
          <div className="text-center h-20 mobile:block tablet:hidden text-2xl mt-8 fixed top-16 left-0 z-10 right-0 text-black bg-white">
            ...
            <div className="flex justify-center text-black mt-2 bg-white text-lg p-2 border-b-4 border-t-4">
              ...
              <div
                className={`fixed top-24 left-0 w-full inset-0 max-h-screen overflow-y-auto bg-white h-full shadow-lg z-20 transform ${
              ...
              >
                ...
                <div className="flex justify-between mt-4 mobile:flex tablet:hidden">
                  <button onClick={applyFilter} className="bg-green-600">
                    Apply
                  </button>
                  <button onClick={resetFilter} className="bg-gray-300">
                    Reset
                  </button>
                </div>
              </div>
