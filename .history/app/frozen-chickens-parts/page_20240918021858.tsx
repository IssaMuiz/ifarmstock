...
import wholeFrozenChickens from "@/public/models/wholeFrozenChickens.json";
...
const FrozenChickensPart = () => {
  ...
  useEffect(() => {
    fetch("/models/wholeFrozenChickens.json")
  ...
  useEffect(() => {
    const filteredProducts = () => {
      ...
      let filtered = [...wholeFrozenChickens];
      ...
      {loading ? (
        ...
        <div>
          <div className="text-center h-20 mobile:block tablet:hidden text-2xl mt-8 fixed top-16 left-0 z-10 right-0 text-black bg-white">
            <p className="mt-6">Frozen Chickens Parts</p>
...
export default FrozenChickensPart;
