  ...
  return (
    <nav className="fixed bg-[#181818] text w-full h-16 flex items-center justify-between top-0 left-0 right-0 px-10">
      ...
      <div className="Rightnav flex items-center justify-between gap-5">
        ...
        <div className="flex relative cursor-pointer p-3 hover:bg-[green]">
          <Image
            ...
            height={20}
          />
          <p className="bgColor h-5 w-5 rounded-full absolute hover:bg-white hover:text-black left-7 bottom-7 text-center">
            10
          </p>
