...
const Footer = () => {
  return (
    <footer>
      <div className="Desktop-footer mobile:hidden tablet:hidden desktop:flex flex-col text w-full">
        <div className=" bg-[#2e2e2e] flex justify-between gap-4 h-20 items-center px-5 w-full">
          <div className="flex desktop:gap-3 tablet:gap-2 items-center cursor-pointer hover:text-[#8a8888] font-semibold">
            <svg
          ...
          <div>
            ...
            <div className="flex items-center gap-1">
              ...
              <button
                type="submit"
                className=" p-2 bg-green-600 hover:bg-[#015722] font-semibold rounded-sm
            "
              >
                Subscribe
              </button>
        ...
        <div className="bg-[#0c0c0c] h-72 p-4 flex items-start gap-10 w-full">
          ...
          <div>
            <div className="flex gap-2">
              <div className="bg-black rounded-sm flex items-center p-2 desktop:w-40 tablet:w-36 gap-2 cursor-pointer">
                <svg
                  fill="#FFFFFF"
                  version="1.1"
                  id="Layer_1"
      ...
      <div className="Mobile-footer mobile:flex tablet:flex desktop:hidden w-full text h-40 flex-col">
        <div className="bg-[#2e2e2e] h-10 text-center">
          <p className="pt-2">BACK TO TOP</p>
        </div>
        <div className="h-32 flex flex-col items-center gap-2 bg-[#0c0c0c] p-4 text-[10px]">
          <div className="flex gap-2">
