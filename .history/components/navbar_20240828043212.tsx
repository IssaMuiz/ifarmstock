...
const Navbar = () => {
  return (
    <nav className="fixed bg-[#080808] text w-full h-16 flex items-center justify-between top-0 left-0 right-0 px-10">
      ...
      <div className="Middlenav flex flex-1 mx-5 max-w-[500px] items-center">
        ...
        />
        <div className="h-10 w-10 bgColor-400 pt-2 pl-1 rounded-r-xl">
          <Image
            className=""
      ...
      <div className="Rightnav flex items-center justify-between gap-5">
        ...
        <div className="flex relative">
          <Image
            ...
            height={30}
          />
          <p className="bg-yellow-500 p-1 rounded-full absolute">3</p>
