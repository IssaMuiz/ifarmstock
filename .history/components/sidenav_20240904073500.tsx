...
const Sidenav = () => {
  ...
  return (
    <nav
      className={`fixed overflow-x-hidden flex items-start flex-row gap-4  z-20   transform transition-transform duration-300   ${
        isOpen ? "translate-x-0" : "-translate-x-full"
      }`}
    >
      <div className="fixed bg-gray-100 tablet:w-[300px] mobile:w-[250px] h-auto overflow-auto left-0 top-0 bottom-0 scrollbar ">
      ...
      <div>
        <p className="text-3xl text font-thin">X</p>
      </div>
    </nav>
  );
};
