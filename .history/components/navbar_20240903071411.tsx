...
const Navbar = () => {
  ...
  return (
    <nav className="Tablet-Display mobile:hidden tablet:block fixed bg-black text w-full h-16 flex items-center justify-between top-0 left-0 right-0 px-10 z-10 ">
