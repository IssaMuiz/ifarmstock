...
const Filter: React.FC<FilterProps> = ({
  ...
  return (
    <section className="Left-side-sorting relative flex-col bg-white p-3 mobile:w-full tablet:w-[300px] rounded-md mobile:h-full tablet:h-[800px]">
      <div className="flex flex-col gap-2 border-b border-gray-400 p-3 mb-3 pb-5 text-left
      ">
        <fieldset className="text-base ">
          <legend className="text-lg font-semibold mb-2 text-left">Brand</legend>
