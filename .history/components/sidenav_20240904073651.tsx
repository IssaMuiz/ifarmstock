...
const Sidenav = () => {
  ...
  return (
    <nav
      className={`fixed overflow-x-hidden flex items-start flex-row gap-4 left-0 top-0 bottom-0 z-20   h-auto transform transition-transform duration-300   ${
        isOpen ? "translate-x-0" : "-translate-x-full"
      }`}
    >
      <div className=" bg-gray-100 tablet:w-[300px] mobile:w-[250px] overflow-auto  scrollbar ">
