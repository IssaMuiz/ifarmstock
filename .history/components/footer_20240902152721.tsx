  ...
  return (
    <footer className="text">
      ...
      <div className="bg-[#0c0c0c] h-80 p-4 flex items-start gap-10">
        ...
        <div className="flex flex-col gap-5">
          <h2 className="text-xl text-[#8a8888]">MAKE MONEY WITH US</h2>
          <div className="text-base flex flex-col gap-2">
        ...
        <div className="flex flex-col gap-5">
          <h2 className="text-xl text-[#8a8888]">PAYMENT METHOD</h2>
          <div className="text-base flex flex-col gap-2">
        ...
        <div className="flex flex-col gap-5">
          <h2 className="text-xl text-[#8a8888]">SERVICES</h2>
          <div className="text-base flex flex-col gap-2">
        ...
        <div className="flex flex-col gap-5">
          <h2 className="text-xl text-[#8a8888]">OTHER LINKS</h2>
          <div className="text-base flex flex-col gap-2">
            <Link href="/">FAQ</Link>
