...
const Sidenav = () => {
  ...
  return (
    <nav
      className={`fixed overflow-x-hidden flex items-start flex-row gap-7 scrollbar h-auto overflow-auto z-20 left-0 top-0 bottom-0 tablet:w-[300px] mobile:w-[250px] transform transition-transform duration-300  bg-gray-100 ${
