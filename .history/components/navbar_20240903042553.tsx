  ...
  return (
    <nav className="fixed bg-black text w-full h-16 flex items-center justify-between top-0 left-0 right-0 px-10 z-10">
      ...
      <div className="Rightnav flex items-center justify-between gap-3">
        <div className="flex items-center gap-1 cursor-pointer rounded-md p-3 sm:p-2 hover:bg-[green]">
          <Image
        ...
        <div className="flex items-center gap-2  cursor-pointer rounded-md p-3 sm:p-2  hover:bg-[green]">
          <Image
        ...
        <div className="flex relative cursor-pointer p-3 sm:p-2  hover:bg-[green] rounded-md">
          <Image
