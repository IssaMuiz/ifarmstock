...
const Navbar = () => {
  ...
  return (
    <nav>
      ...
      <div className="Mobile-nav mobile:flex flex-col tablet:hidden fixed top-0 left-0 right-0 h-28 w-full items-center bg-black text z-10 px-3 justify-between">
        ...
        <div>
          <div className="flex flex-1 mx-5 max-w-[700px] items-center">
            <input
              className=" px-5 py-2 w-full rounded-l-xl text-black outline-none"
              type="text"
              placeholder="Search for products, services and categories"
