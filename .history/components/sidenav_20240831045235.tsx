...
const Sidenav = () => {
  ...
  return (
    <nav
      className={`fixed h-screen overflow-scroll z-20 left-0 top-0 bottom-0 w-[300px] transform transition-transform duration-300  bg-gray-100 ${
    ...
    >
      ...
      <div className=" overflow-x-hidden scrollbar pb-5">
