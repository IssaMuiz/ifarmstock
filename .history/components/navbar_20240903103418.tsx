...
const Navbar = () => {
  ...
  return (
    <nav>
      ...
      <div className="Mobile-nav mobile:flex flex-col tablet:hidden fixed top-0 left-0 right-0 h-24 w-full items-center bg-black text z-10 px-3 ">
        <div className=" flex items-center justify-between w-full">
          ...
          <div className="flex items-center">
            ...
            <div className="flex relative cursor-pointer p-3  rounded-md">
              <Image
                src="/assets/icons/cart.png"
                alt="cart-icon"
                width={25}
        ...
        <div>
          <div className="flex flex-1 mx-5 items-center w-full">
            <input
              className=" px-5 py-2 w-[420px] rounded-l-xl text-black outline-none"
              type="text"
              placeholder="Search for products, services and categories"
            />
            <div className="h-[37px] w-10 bgColor pt-2 pl-2 rounded-r-xl cursor-pointer">
