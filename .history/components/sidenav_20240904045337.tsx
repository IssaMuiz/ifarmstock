...
const Sidenav = () => {
  ...
  return (
    <nav
      className={`fixed overflow-x-hidden scrollbar h-screen overflow-scroll z-20 left-0 top-0 bottom-0 h-screen tablet:w-[300px] mobile:w-[250px] transform transition-transform duration-300  bg-gray-100 ${
