...
const Sidenav = () => {
  ...
  return (
    <nav
      className={`fixed overflow-x-hidden flex items-start flex-row gap-7 scrollbar h-auto overflow-auto z-20 left-0 top-0 bottom-0  transform transition-transform duration-300   ${
