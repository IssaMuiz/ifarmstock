    ...
    <div className="bg-white h-auto  p-4">
      <div className="grid grid-cols-4  gap-5">
        {newArrivalsCards.map((product, index) => (
          <div
            key={index}
            className="flex shadow-md hover:shadow-lg hover:scale-10 hover:transition-all hover:duration-300 hover:ease-in-out flex-col p-4 gap-3 rounded-md cursor-pointer"
          >
            <Image
              src={product.image}
              alt="poultry"
