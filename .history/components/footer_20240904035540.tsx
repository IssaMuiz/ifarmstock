...
const Footer = () => {
  return (
    <footer className="text w-full border-b border-gray-100 pb-5">
      ...
      <div className="mobile:flex tablet:hidden flex-col">
        <div className="w-full h-8 bg-[#2e2e2e] text-center">Back to top</div>
        <div className="bg-[#0c0c0c] h-20">Footer</div>
      </div>
    </footer>
  );
};
