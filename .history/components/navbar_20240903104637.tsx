...
const Navbar = () => {
  ...
  return (
    <nav>
      ...
      <div className="Mobile-nav mobile:flex flex-col tablet:hidden fixed top-0 left-0 right-0 h-24 w-full items-center py-3 gap-2 bg-black text z-10 px-3 shadow-xl">
        ...
        <div>
          <div className="flex flex-1 mx-5 items-center w-full">
            <input
              className=" px-5 py-2 w-[420px] rounded-l-md text-black outline-none"
              type="text"
              placeholder="Search for products, services and categories"
            />
