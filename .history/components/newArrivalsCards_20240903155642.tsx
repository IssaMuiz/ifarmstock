...
const NewArrivalsCards = () => {
  ...
  return (
    <div className="bg-white h-auto w-auto tablet:p-4 mobile:p-1">
      <div
        /* className="grid tablet:grid-rows-2 desktop:grid-cols-5 tablet:grid-cols-3 mobile:grid-cols-2 w-auto tablet:gap-5 mobile:gap-2" */ className="flex overflow-x-auto space-x-4 p-4 w-[200px]"
      >
