...
const Sidenav = () => {
  ...
  return (
    <nav
      className={`fixed h-auto z-20 left-0 top-0 bottom-0 w-[300px] transform transition-transform duration-300 bg-gray-100 mt-20 ${
      ...
      <div>
        {categories.map((category) => (
          <div onClick={() => handleDropdown(category.id)} key={category.id}>
            ...
            <div>
              {category.expanded && (
                <div className="transform scale-y-0 origin-top transition-all duration-300 ease-in-out">
