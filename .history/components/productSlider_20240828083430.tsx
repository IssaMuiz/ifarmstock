  ...
  return (
    <div className="relative w-[800px] overflow-hidden">
      ...
      <button
        ...
        className="absolute left-0 top-1/2 tranform -translate-y-1/2 bg-gray-200 text-white px-2 py-2 opacity-75 hover:opacity-100 transition-opacity"
      >
        <Image
          className=""
      ...
      <button
        ...
        className="absolute right-0 top-1/2 tranform -translate-y-1/2 bg-gray-200 text-white px-2 py-2 opacity-75 hover:opacity-100 transition-opacity"
      >
        <Image
          className=""
