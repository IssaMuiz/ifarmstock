...
const Navbar = () => {
  return (
    <nav className="fixed bg-black text w-full h-16 flex items-center justify-between top-0 left-0 right-0 px-10">
      <div>
        <svg
      ...
      <div className="Rightnav flex items-center justify-between gap-3">
        ...
        <div className="flex relative cursor-pointer p-3 hover:bg-[green] rounded-md">
          <Image
            ...
            height={20}
          />
          <p className="bgColor h-5 w-5 rounded-full absolute left-7 bottom-8 text-center">
            10
          </p>
