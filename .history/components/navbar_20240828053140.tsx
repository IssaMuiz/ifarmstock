...
const Navbar = () => {
  return (
    <nav className="fixed bg-[#181818] text w-full h-16 flex items-center justify-between top-0 left-0 right-0 px-10">
      ...
      <div className="Middlenav flex flex-1 mx-5 max-w-[600px] items-center">
        <input
      ...
      <div className="Rightnav flex items-center justify-between gap-5">
        ...
        <div className="flex relative cursor-pointer p-3">
          <Image
          ...
          <p className="font-semibold mt-2 hover:text-[green]">Cart</p>
        </div>
      </div>
    </nav>
  );
