...
const ProductSlider = () => {
  ...
  return (
    <div className="relative mt-5 md:w-[800px] sm:w-[600px] overflow-hidden flex gap-2">
      <div
      ...
      <div>
        <div className="grid grid-cols-2">
          <Image
            src="/assets/images/package-chicken1.jpg"
            alt=""
            width={50}
            height={50}
          />
          <Image
            src=""
            alt="/assets/images/package-chicken2.jpg"
            width={50}
            height={50}
          />
          <Image src="/assets/images/egg1.jpg" alt="" width={50} height={50} />
          <Image
            src="/assets/images/chicken-liver.jpg"
            alt=""
            width={50}
            height={50}
          />
