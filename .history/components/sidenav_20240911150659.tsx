  ...
  const [categories, setCategories] = useState([
    {
      ...
      dropdownlink: [
        ...
        { name: "Broilers Bulk Purchases", link: "/Broilers-bulk-purchases" },
      ],
    },
    {
      id: "2",
      ...
      arrowIcon: "/assets/icons/arrow-icon--right.png",
      dropdownlink: [
        { name: "Whole Frozen Chickens", link: "/" },
        { name: "Frozen Chickens Parts", link: "/" },
        { name: "Bulk Purchases Frozens Chickens", link: "/" },
      ],
    },
    {
      id: "3",
