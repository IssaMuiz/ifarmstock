...
const Sidenav = () => {
  ...
  return (
    <nav
      className={`fixed h-auto z-20 left-0 top-0 bottom-0 w-[300px] transform transition-transform duration-300 pb-5 bg-gray-100 ${
    ...
    >
      ...
      <div className="overflow-scroll overscroll-x-none scrollbar">
