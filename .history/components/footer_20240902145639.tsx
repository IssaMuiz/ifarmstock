      ...
      <div className="bg-[#0c0c0c] h-80 p-4 flex items-start gap-10">
        ...
        <div>
          <div className="flex gap-2">
            <div className="bg-black rounded-sm flex items-center p-2 w-40 gap-2">
              <svg
                fill="#FFFFFF"
                version="1.1"
                id="Layer_1"
            ...
            <div className="bg-black rounded-sm flex items-center p-2 w-40 gap-2 hover:text-green-600 hover:fill-green-600 cursor-pointer">
              <svg
                className=""
                fill="#FFFFFF"
                xmlns="http://www.w3.org/2000/svg"
