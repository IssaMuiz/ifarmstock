...
const Navbar = () => {
  ...
  return (
    <nav className="fixed bg-black text w-full h-16 flex items-center justify-between top-0 left-0 right-0 px-10 z-10">
      ...
      <div className="Leftnav text text-3xl font-semibold cursor-pointer ml-5">
        <p className="sm:hidden md:block">Grow</p>
        <p className="sm:block md:hidden">G</p>
      </div>
      <div className="Middlenav flex flex-1 mx-5 max-w-[700px] items-center">
        ...
        />
        <div className="h-[37px] w-10 bgColor pt-2 sm:pl-1 pl-2 rounded-r-xl cursor-pointer">
          <Image
            className=""
      ...
      <div className="Rightnav flex items-center justify-between gap-3">
        <div className="flex items-center gap-1 cursor-pointer rounded-md md:p-3 sm:p-2 hover:bg-[green]">
          <Image
        ...
        <div className="flex items-center gap-2  cursor-pointer rounded-md md:p-3 sm:p-2  hover:bg-[green]">
          <Image
        ...
        <div className="flex relative cursor-pointer md:p-3 sm:p-2  hover:bg-[green] rounded-md">
          <Image
            ...
            height={20}
          />
          <p className="bg-white h-5 w-5 rounded-full text-black absolute left-7 md:bottom-7 bottom-6 text-center font-semibold">
            10
          </p>
