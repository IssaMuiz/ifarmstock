...
const Navbar = () => {
  ...
  return (
    <nav>
      ...
      <div className="Mobile-nav mobile:flex flex-col tablet:hidden fixed top-0 left-0 right-0 h-24 w-full items-center bg-black text z-10 px-3 justify-between">
