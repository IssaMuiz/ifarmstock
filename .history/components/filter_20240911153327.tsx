        ...
        <fieldset className="text-base">
          ...
          <label className="flex items-center gap-2 mb-2 cursor-pointer w-max">
            ...
            <input
              ...
              name="weight"
              value="0 - 1"
              checked={priceRange?.[0] === 0 && priceRange?.[1] === 1}
              onChange={() => togglePrice([1000, 3000])}
              className="mr-2 hidden"
            />
            0 - 1kg
          ...
          <label className="flex items-center gap-2 mb-2 cursor-pointer w-max">
            <div
              className={`w-2 h-2 mr-2 relative p-2 rounded-full border-2 hover:border-green-600 ${
                weightRange?.[0] === 3000 && weightRange[1] === 5000
                  ? "border-green-600 bg-green-600"
                  : "border-gray-400"
              }`}
            ></div>
            <input
              ...
              name="price"
              value="3000 - 5000"
              checked={weightRange?.[0] === 3000 && weightRange?.[1] === 5000}
              onChange={() => togglePrice([3000, 5000])}
              className="mr-2 hidden"
            />
            &#8358;3000 - &#8358;5000
          ...
          <label className="flex items-center gap-2 mb-2 cursor-pointer w-max">
            <div
              className={`w-2 h-2 mr-2 relative p-2 rounded-full border-2 hover:border-green-600 ${
                weightRange?.[0] === 5000 && weightRange?.[1] === 8000
                  ? "border-green-600 bg-green-600"
                  : "border-gray-400"
              }`}
            ></div>
            <input
              ...
              name="price"
              value="5000 - 8000"
              checked={weightRange?.[0] === 5000 && weightRange?.[1] === 8000}
              onChange={() => togglePrice([5000, 8000])}
              className="mr-2 hidden"
            />
            &#8358;5000 - &#8358;8000
          ...
          <label className="flex items-center gap-2 mb-2 cursor-pointer w-max">
            <div
              className={`w-2 h-2 mr-2 relative p-2 rounded-full border-2 hover:border-green-600 ${
                weightRange?.[0] === 8000 && weightRange?.[1] === 10000
                  ? "border-green-600 bg-green-600"
                  : "border-gray-400"
              }`}
            ></div>
            <input
              ...
              name="price"
              value="8000 - 10000"
              checked={weightRange?.[0] === 8000 && weightRange?.[1] === 10000}
              onChange={() => togglePrice([8000, 10000])}
              className="mr-2 hidden"
            />
            &#8358;8000 - &#8358;10000
