...
const Footer = () => {
  return (
    <footer className="text">
      ...
      <div className="bg-[#0c0c0c] h-80 p-4 flex items-start gap-10">
        <div className="flex flex-col gap-5">
          <h2 className="text-base text-[#8a8888]">ABOUT US</h2>
        ...
        <div className="flex flex-col gap-5">
          <h2 className="text-base text-[#8a8888]">PAYMENT METHOD</h2>
        ...
        <div className="flex flex-col gap-5">
          <h2 className="text-base text-[#8a8888]">SERVICES</h2>
          <div className="text-base flex flex-col gap-2">
            <Link href="/">Poultry health</Link>
            <Link href="/">Fish maintainance</Link>
            <Link href="/">Bio security</Link>
          </div>
        </div>
        <div className="flex flex-col gap-5">
          <h2 className="text-base text-[#8a8888]">OTHER LINKS</h2>
          <div className="text-base flex flex-col gap-2">
            <Link href="/">FAQ</Link>
        ...
        <div className="flex flex-col gap-5">
          <h2 className="text-base text-[#8a8888]">MAKE MONEY WITH US</h2>
          <div className="text-base flex flex-col gap-2">
            <Link href="/">Become a sales consultant</Link>
            <Link href="/">Join our farm consultant team</Link>
          </div>
        </div>
        <div>
          ...
          <div className="mt-10">
            ...
            <div className="flex gap-3">
              ...
              >
                ...
                <path
                  d="M42.415,7H21.581C13.542,7,7,13.544,7,21.585v20.833C7,50.458,13.544,57,21.585,57h20.833C50.458,57,57,50.456,57,42.415V21.581C57,13.542,50.456,7,42.415,7z M32,45c-7.17,0-13-5.831-13-13s5.83-13,13-13s13,5.83,13,13S39.169,45,32,45z M47,19
	c-1.104,0-2-0.896-2-2s0.896-2,2-2s2,0.896,2,2S48.104,19,47,19z"
                />
              </svg>
            </div>
          </div>
